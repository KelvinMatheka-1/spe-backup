        ...
        <div className="w-full">
          ...
          <div className="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
            <form action="" onSubmit={handleSubmit}>
              ...
              <div className="mb-5">
                <label for="event name" className="block mb-2 font-bold text-gray-600">Event Name</label>
              ...
              <div className="mb-5">
                <label for="Image Poster url" className="block mb-2 font-bold text-gray-600">Poster Url</label>
              ...
              <div className="mb-5">
                <label for="description" className="block mb-2 font-bold text-gray-600">Description</label>
              ...
              <div className="mb-5">
                <label for="Location_id" className="block mb-2 font-bold text-gray-600">Location ID</label>
              ...
              <div className="mb-5">
                <label for="date" className="block mb-2 font-bold text-gray-600">Date</label>
              ...
              <div className="mb-5">
                <label for="time" className="block mb-2 font-bold text-gray-600">Time</label>
              ...
              <div className="mb-5">
                <label for="runs_till" className="block mb-2 font-bold text-gray-600">Runs till</label>
              ...
              <div className="mb-5">
                <label for="category" className="block mb-2 font-bold text-gray-600">Category</label>
              ...
              <div className="mb-5">
                <label for="ticket_regular" className="block mb-2 font-bold text-gray-600">Ticket price regular</label>
              ...
              <div className="mb-5">
                <label for="ticket_vip" className="block mb-2 font-bold text-gray-600">Ticket price vip</label>
              ...
              <div className="mb-5">
                <label for="ticket_vvip" className="block mb-2 font-bold text-gray-600">Ticket price vvip</label>
